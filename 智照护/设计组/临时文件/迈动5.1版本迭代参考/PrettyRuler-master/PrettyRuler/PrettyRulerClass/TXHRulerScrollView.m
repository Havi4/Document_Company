...
- (void)drawRuler {
    ...
    for (int i = 0; i <= self.rulerCount; i++) {
        ...
        if (i % 10 == 0) {
            ...
            view.frame = CGRectMake(DISTANCELEFTANDRIGHT + DISTANCEVALUE * i-5, DISTANCETOPANDBOTTOM, 10, 10);
            ...
            [rule sizeToFit];
            rule.transform = CGAffineTransformMakeRotation(degreeTOradians(90));
        ...
        else
        {
            ...
            UIView *view = [[UIView alloc]init];
            view.frame = CGRectMake(DISTANCELEFTANDRIGHT + DISTANCEVALUE * i-2.5, DISTANCETOPANDBOTTOM, 5, 5);
